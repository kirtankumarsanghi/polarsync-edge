...
export default function VectrusLayout({
  children,
}: {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface select-none">
      {/* Fixed Top Header */}
      <header className="fixed top-0 left-0 right-0 h-10 z-50 bg-surface-container-low shadow-[0_1px_8px_rgba(0,0,0,0.04)] flex items-center justify-between px-space-md">
      ...
      {/* Fixed Left Sidebar */}
      <aside className="fixed left-0 top-10 bottom-8 w-12 z-40 bg-surface-container-low shadow-[0_1px_8px_rgba(0,0,0,0.04)] flex flex-col items-center py-space-sm gap-space-sm">
      ...
      <div className="pl-12 pb-8">
        <main className="w-full pt-10 min-h-screen bg-background">
          {children}
        </main>
      </div>

      {/* Fixed Bottom Status Bar */}
      <footer className="fixed bottom-0 left-0 right-0 h-8 z-50 bg-surface-container-low shadow-[0_1px_8px_rgba(0,0,0,0.04)] flex items-center justify-between px-space-md">
        <div className="flex items-center gap-space-md">
          <div className="flex items-center gap-space-xs">
          ...
          <div className="font-terminal-stream text-terminal-stream text-on-surface-variant truncate max-w-2xl">
            [21:54:09.814] [INTERTIE-N1] Power balance stable. Frequency delta +0.012 mHz. Auto-regulation engaged.
          </div>
        </div>
